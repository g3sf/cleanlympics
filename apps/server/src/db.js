...
CREATE TABLE IF NOT EXISTS submissions(id INTEGER PRIMARY KEY,team_id INTEGER NOT NULL REFERENCES teams(id),checklist_id INTEGER NOT NULL REFERENCES checklists(id),submitted_by INTEGER REFERENCES users(id),work_date TEXT NOT NULL,completion_percent REAL NOT NULL,base_points REAL NOT NULL,bonus_points REAL NOT NULL DEFAULT 0,penalty_points REAL NOT NULL DEFAULT 0,total_points REAL NOT NULL,status TEXT NOT NULL DEFAULT 'pending',submitted_at TEXT DEFAULT CURRENT_TIMESTAMP,UNIQUE(team_id,checklist_id,work_date));
...
export function seed(){
 ...
 [['season_name','Launch Season'],['season_theme','The Launch of the Cleanlympics'],['season_start','2026-09-01'],['season_end','2026-09-30'],['season_current_week','1']].forEach(x=>setting.run(x[0],x[1]));
}
